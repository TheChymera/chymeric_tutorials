...
Based on the above we have written a Python script (named **[Risky]()**) that can be used to calculate the voctory, tie, and defeat odds given $a$ attackers, $d$ defenders, and $s$ sides of the dice.
